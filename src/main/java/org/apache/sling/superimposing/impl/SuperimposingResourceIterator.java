...
public class SuperimposingResourceIterator implements Iterator<Resource> {
    ...
    SuperimposingResourceIterator(
            SuperimposingResourceProviderImpl superimposingProvider, Iterator<Resource> decoratee) {
    ...
    private void seek() {
        ...
        while (next == null && decoratee.hasNext()) {
            ...
            final String superimposingPath =
                    SuperimposingResourceProviderImpl.reverseMapPath(superimposingProvider, resource.getPath());
