...
public class SuperimposingResourceProviderImpl implements SuperimposingResourceProvider {
     ...
     * @return Mapped path or null if no mapping available
     */
    static String mapPathWithOverlay(
            SuperimposingResourceProviderImpl provider, ResourceResolver resolver, String path) {
    ...
    public boolean equals(Object o) {
        if (o instanceof SuperimposingResourceProviderImpl) {
            ...
            return this.rootPath.equals(srp.rootPath)
                    && this.sourcePath.equals(srp.sourcePath)
